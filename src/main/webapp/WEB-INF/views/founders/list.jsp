...
<body>
    ...
    <form:form modelAttribute="founder">    
        ...
        <div class="container-fluid" style="margin-right:70px;margin-left:70px;">
            ...
            <div class="row-fluid" style="padding:0px;height:300px;margin:0;background-color:lightgray;" id="firstFluid">
                ...
                <div class="row-fluid" style="padding:0px;height:145px;margin:0;background-color:lightgray;" id="firstFluid">
                <div class="span4" style="margin-top:0px;margin-left:5px;margin-bottom:5px;background-color:lightgrey;height:100%;position:relative;">
                    <h3 id="firstNameFounder" style="top:0;padding:0;margin:0;"></h3>
                    <p id="currentCompanyFounder" style="margin:0;"></p>
                    
                </div>

                <div class="span2" style="margin-top:0px;margin-bottom:0px;background-color:lightgrey;height:100%;position:relative;" id="founder-picutre"></div>
                </div>
                    
                <div class="row-fluid" style="padding:0px;height:150px;margin:0;background-color:lightgray;" id="firstFluid">
                    <div class="span6" style="margin-top:0px;margin-left:5px;margin-bottom:0px;background-color:#f6f6f6;height:100%;position:relative;">
                        <a href="<c:url value="create" />"><img src="/mentormarketplace/resources/img/edit.png" style="padding:0;height:30px;width:30px;position:absolute;top:0;right:0;" /></a>
            ...
            function loadData() {
                IN.API.Profile("me")
                        ...
                        .result(function(result) {
                            ...
                            picHTML = "<img style=\"height:75px;width:100px;right:0;float:right;border-radius:50%;\" class=img_border align=\"left\" src=\"" + profile.pictureUrl + "\"></a>";
                            $("#founder-picutre").html(picHTML);
                        });
            }
    </script>
